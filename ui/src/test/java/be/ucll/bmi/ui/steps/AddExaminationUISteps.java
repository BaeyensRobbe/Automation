...
public class AddExaminationUISteps extends UISteps {
    ...
    public void the_examination_should_be_added_to_tom_s_examinations(String name) {
        ...
        Examination contextExamination = context.getExamination();
        assertEquals(contextExamination.getLength(), patientDetailsPage.getLength());
        assertEquals(contextExamination.getWeight(), patientDetailsPage.getWeight());
        assertEquals(contextExamination.getExaminationDate(), patientDetailsPage.getExaminationDate());
    }
